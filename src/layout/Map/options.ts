export default {
  accessToken:
    'pk.eyJ1IjoiY3VpemloYW8xOTkyIiwiYSI6ImNqa25lMmV6ZzAwdTAza3BjYXRqN3ozM3cifQ.TMJ1VTkOqGFQl4cyu0Jm3A',
  center: [114.2, 22.528499],
  zoom: 9,
  maxZoom: 17.5,
  minZoom: 5,
  pitch: 45,
  ...
  mapStyle: {
    ...
    bearing: 0,
    pitch: 0,
    // sprite: process.env.VUE_APP_BASE_URL + '/offlinemap/sprite',
